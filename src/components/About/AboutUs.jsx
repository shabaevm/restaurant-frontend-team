      ...
      <div className={cl.cardInfo__aboutUs}>
        ...
        <div className={cl.info__aboutUs}>
          ...
          <div className={cl.p__aboutUs}>
            <p>
              Известный шеф-повар. Специализируется на
              современной русской, кавказской и азиатской кухнях. В послужном
              списке Бурака Оздемира работа в лучших гастрономических
              ресторанах: от самого высокого ресторана Европы Sixty до
              небольшого ресторанчика Saimaa Life Gastrocafe в Финляндии.
              Сегодня Бурак является бренд-шефом одного из ключевых ресторанов
              Эмина Агаларова – Halal.
            </p>
          </div>
        </div>
      </div>
